...
public class NurseSampleOutgoingPageObject {
	...
	public String getTheType3() {
		return Type3.getText();
	}
	@FindBy(xpath = "(//td)[49]")
	private WebElement Type4;

	public String getTheType4() {
		return Type4.getText();
	}
	@FindBy(xpath = "(//td)[61]")
	private WebElement Type5;

	public String getTheType5() {
		return Type5.getText();
	}
