...
public class PrintReceipt {
	...
	public void onePrintReceiptAndFeedbackAndLogOut() throws Throwable {
		...
		if (LabJuniorWorkList.Hamoglobin_Status == true) {
			totalReferralCount--;
		}
		if (LabJuniorWorkList.SGOT_Status == true) {
			totalReferralCount--;
		}
		...
		if (LabJuniorWorkList.Creatinine_Status == true) {
			totalReferralCount--;
		}

		if (LabJuniorWorkList.Glucose_Status == true) {
			totalReferralCount--;
		}
