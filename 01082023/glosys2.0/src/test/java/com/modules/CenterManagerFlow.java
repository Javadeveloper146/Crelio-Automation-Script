...
//		CenterManager.getInstance().clickThePrint();
	...
	public static void external_Barcode_Generation() throws Throwable {
		CommonUtility.sleepControl(1000);
		LabConfirmatory.ReGenarate_Specimen_Number_External_1 = LabDirector.getInstance().getTheSpecimenNumebr();
		LOGGER.info("Specimen Number" + ": " + LabConfirmatory.ReGenarate_Specimen_Number_External_1);

		// Get The External Specimen Name
		CommonUtility.sleepControl(1000);
		LabConfirmatory.External_SpecimenNumber_ID_1 = (LabDirector.getInstance().getTheExternalSpecimenNumber());
		LOGGER.info("External Specimen Name" + ": " + LabConfirmatory.External_SpecimenNumber_ID_1);
		// Click The Print
		CommonUtility.sleepControl(2000);
