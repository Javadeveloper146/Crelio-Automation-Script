...
public class PropertiesFile {
	...
	public void constantProperties() {
		...
		ConstantProperties.PATIENT_NAME = properties.getProperty("PatientName");
		ConstantProperties.TEST_NAME = properties.getProperty("Test_Name");
		ConstantProperties.GENDER = properties.getProperty("Gender");
		ConstantProperties.AGE = properties.getProperty("Age");
		// Incoorect UserName
		...
		ConstantProperties.TOKEN_FLOW = properties.getProperty("Token_Flow");
		...
		ConstantProperties.QUANTIFERON_APPROVAL = properties.getProperty("QuantiferonCLA_Result");
		...
		ConstantProperties.SYSTEM_CONFIGURATION= properties.getProperty("System_Configuration");

		ConstantProperties.PARTNER_HOSPITAL_LOGIN = properties.getProperty("Partner_Hospital_Login");
	}
}
