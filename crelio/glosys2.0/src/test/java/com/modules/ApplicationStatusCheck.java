...
//		screenShortForCertification();
	...
	public void screenShortForApplicationVisitAtQMC() throws IOException {
		TakesScreenshot screenshot = (TakesScreenshot) DriverManager.getDriver();
		File sourceFile = screenshot.getScreenshotAs(OutputType.FILE);
		File correctLocation = new File(
				"C:\\Users\\user\\Downloads\\glosys2.0\\ApplicationStatusCheck\\ApplicationVisitAtQmc.png");
		FileHandler.copy(sourceFile, correctLocation);

		JavascriptExecutor executor = (JavascriptExecutor) DriverManager.getDriver();
		executor.executeScript("window.scrollTo(0, document.body.scrollHeight)");
	}

	public void screenShortForReporting() throws IOException {
		TakesScreenshot screenshot = (TakesScreenshot) DriverManager.getDriver();
		File sourceFile = screenshot.getScreenshotAs(OutputType.FILE);
		File correctLocation = new File("C:\\Users\\user\\Downloads\\glosys2.0\\ApplicationStatusCheck\\Reporting.png");
		FileHandler.copy(sourceFile, correctLocation);
	...
	public void screenShortForCertification() throws IOException {
		TakesScreenshot screenshot = (TakesScreenshot) DriverManager.getDriver();
		File sourceFile = screenshot.getScreenshotAs(OutputType.FILE);
		File correctLocation = new File(
				"C:\\Users\\user\\Downloads\\glosys2.0\\ApplicationStatusCheck\\Certification.png");
		FileHandler.copy(sourceFile, correctLocation);
	...
	public void screenShortForCurrentStatus() throws IOException {
		TakesScreenshot screenshot = (TakesScreenshot) DriverManager.getDriver();
		File sourceFile = screenshot.getScreenshotAs(OutputType.FILE);
		File correctLocation = new File(
				"C:\\Users\\user\\Downloads\\glosys2.0\\ApplicationStatusCheck\\Current Status.png");
		FileHandler.copy(sourceFile, correctLocation);
